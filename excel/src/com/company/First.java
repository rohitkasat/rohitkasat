...
import static com.company.First.main_panel;
...
class Execute
{
    public static JButton single_data,multiple_data;
    ...
    public Execute()
    {
        ...
        single_data = new JButton("single data");
        single_data.addActionListener(new ButtonListener());

        multiple_data = new JButton("multiple data");
        multiple_data.addActionListener(new ButtonListener());




        panel.add(single_data);
        panel.add(multiple_data);
    ...
    public static class ButtonListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == single_data) {
                System.out.println("Single data pressed");
                First.S=e.getActionCommand();
            } else if (e.getSource() == multiple_data) {
                //multiple data
                System.out.println("Multiple data pressed");
                First.S=e.getActionCommand();
            }
