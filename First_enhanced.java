...
public class First extends JFrame {
    ...
    public String getCSVString(ArrayList<String> list) throws IOException {
        ...
        public First() {
            ...
            //emailId.setText("(optional)");
            //int size = emailId.getSize();
//
...
//
//                    data.add("BENEFICIARY NAME");
//                    data.add("BENEFICIARY ACCOUNT NUMBER");
//                    data.add("IFSC");
//                    data.add("TRANSACTION TYPE");
//                    data.add("DEBIT ACCOUNT NUMBER");
...
//                    data.add("REMARKS");
                    ...
                    if(!b){
                        JLabel ema1 = new JLabel();
                        ema1.setVisible(true);
                        ema1.setBounds(175, 520, 175, 25);

                        ema1.setForeground(Color.red);
                        ema1.setText("enter a valid email-id");
                        main_panel.add(ema1);
                    }
                    else {
